...
The hardware configuration module is a function that takes, at least,
...
Set the default \nix{maxJobs} to \nix{8}, the number of cores.

\todoo{Link to maxJobs documentation}
